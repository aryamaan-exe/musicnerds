            ...
            <div className="flex flex-col m-4 justify-center items-center *:w-[75%]">
                {results.map((album) => {
                    ...
                    <CardBody className="flex flex-row gap-8">
                        <Image fallbackSrc="https://raw.githubusercontent.com/aryamaan-exe/musicnerds/refs/heads/main/pages/fallbackimage.png" src={album.url} width={150} height={150}></Image>
                        <div>
